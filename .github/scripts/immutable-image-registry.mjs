...
const CANONICAL_SOURCE = 'https://github.com/DevPathAi/devpath-community-svc';
const CANONICAL_REPOSITORY = 'DevPathAi/devpath-community-svc';
const CANONICAL_IMAGE = 'ghcr.io/devpathai/devpath-community-svc';
