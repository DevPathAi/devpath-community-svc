# CLAUDE.md — devpath-community-svc

> 커뮤니티 서비스 — 게시판, 평판, 배지, 모더레이션
...
- 패키지: `ai.devpath.community` / 메인: `CommunityApplication`
- 설계: [documents/20_커뮤니티_기능_설계서](https://github.com/DevPathAi/documents/blob/main/20_커뮤니티_기능_설계서.md)
...
| 모듈 | 역할 |
|------|------|
| post | 5개 게시판(Q&A/자유/프로젝트/스터디/수료자) |
| reputation | 평판 엔진 + sockpuppet 탐지 |
